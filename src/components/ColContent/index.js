...
class ColContent extends React.Component {
  static propTypes = {
    content: PropTypes.oneOfType([PropTypes.string, PropTypes.node]), // 传入的内容
  ...
  render() {
    ...
    switch (position) {
      case 'left':
        className = Styles.cloContent_box_left
        break
      case 'center':
        className = Styles.cloContent_box_center
        break
      case 'right':
        className = Styles.cloContent_box_right
        break
      default:
        className = Styles.cloContent_box_center
    }
